...
void makeOsLepPairs(const std::set<diLepEvent_t>& firedDiLepTrigs, const std::vector<Muon*>& MuVec, const std::vector<Electron*> & ElVec, std::list<osPair> & osPairs) {
  ...
  pMuList.sort(desy_tools::compare_Pointer_Pt<Particle, Particle>);
  nMuList.sort(desy_tools::compare_Pointer_Pt<Particle, Particle>);
  pElList.sort(desy_tools::compare_Pointer_Pt<Particle, Particle>);
  nElList.sort(desy_tools::compare_Pointer_Pt<Particle, Particle>);
