...
Systematics::BTagReweight::BTagReweight( TString variation_){
  ...
  BTagReshape_upBC      = new BTagShapeInterface( "csvdiscr.root", 1.0, 0.0);
  BTagReshape_downBC    = new BTagShapeInterface( "csvdiscr.root",-1.0, 0.0);
  BTagReshape_upLight   = new BTagShapeInterface( "csvdiscr.root", 0.0, 1.0);
  BTagReshape_downLight = new BTagShapeInterface( "csvdiscr.root", 0.0,-1.0);
}
